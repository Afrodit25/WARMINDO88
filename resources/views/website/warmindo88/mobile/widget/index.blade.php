        ...
        <div class="main-content home">
            <section class="home__slider">
                <div class="swiper-container main-slider swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper" id="swiper-wrapper-a62fcbdef1cad796" aria-live="off"
                    ...
                    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                        aria-controls="swiper-wrapper-a62fcbdef1cad796"></div>
                ...
                <div class="container">
                    <div class="mobile-category-container">
                        <div
                            ...
                            <div class="swiper-wrapper" id="swiper-wrapper-3fa47d99ccccfa10e" aria-live="polite"
                                        ...
                                        <div class="category-item">
                                            <div class="icon">
                                                <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/popular.svg"
                                                    width="60" height="60" alt="popular">
                                            </div>
                        ...
                        <button class="navigation navigation-prev--category swiper-button-disabled" disabled=""
                            tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-3fa47d99ccccfa10e"
                            aria-disabled="true">
                            <i class="fas fa-angle-left"></i>
                        </button>
                        <button class="navigation navigation-next--category" tabindex="0" aria-label="Next slide"
                            aria-controls="swiper-wrapper-3fa47d99ccccfa10e" aria-disabled="false">
                ...
                <div class="container">
                    ...
                    <div class="provider-list__item">
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=AFC&amp;gameCode=AFC&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=PLC&amp;gameCode=PLC&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=WEC&amp;gameCode=WEC&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=GD8&amp;gameCode=GD8&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=WMC&amp;gameCode=WMC&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=ORI&amp;gameCode=ORI&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
            ...
            <section class="mobile__provider-list provider-list--sports">
                <div class="container">
                    ...
                    <div class="provider-list__item">
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=AFB&amp;gameCode=AFB&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=IAE&amp;gameCode=IAE&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=SBO&amp;gameCode=SBO&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
            ...
            <div class="mobile__provider-list provider-list--slot">
                <div class="container">
                    ...
                    <div class="provider-list__item">
                        ...
                        <div class="item-holder">
                            <a href="https://mahacuan.support/gameIframe?providerCode=NLS&amp;gameCode=NLS&amp;isTrial=0"
                                target="window-play">
                                <div class="item-img">
                    ...
                    <div class="mobile-download-container">
                        ...
                        <div class="download-button">
                            <a class="btn-custom-sm"
                                href="/download/app-9d31f8e2973dcb6969795466294bad1bb9b014d0">Download</a>
                        </div>
                    </div>
                </div>
            </section>
