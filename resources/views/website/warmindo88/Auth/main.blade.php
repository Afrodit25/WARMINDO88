...
<!-- Mirrored from mahacuan.lol/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 15:29:53 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Canonical -->
    <link rel="canonical" href="{{ asset('/') }}template_mahacuan/mahacuan.support/" />
    <!-- End Canonical -->
...
<body>
    ...
    <!-- Add LOGIN Modal -->
    @include('website.warmindo88.Auth.modal_login_website')
    <!-- /Add LOGIN Modal -->
                                ...
                                <div class="container-fluid text-center justify-content-center">
                                    <div class="game-item game-item-new">
                                        <a onclick="routeNav('/slot/ais')" href="javascript:;">
                                            ...
                                            <img title="AIS GAMING" alt="AIS GAMING" class="game-new"
                                                src="https://images.linkcdn.cloud/global/nav-addons/promo.webp">
                                        </a>
                                    </div>
                                    <div class="game-item game-item-new">
                                        <a onclick="routeNav('/slot/pragmaticplay')" href="javascript:;">
                                            ...
                                            <img title="Pragmatic Play" alt="Pragmatic Play" class="game-new"
                                                src="https://images.linkcdn.cloud/global/nav-addons/promo.webp">
                                        </a>
                                    </div>
                                    <div class="game-item game-item-new">
                                        <a onclick="routeNav('/slot/pgsoft')" href="javascript:;">
                                            ...
                                            <img title="PG Soft" alt="PG Soft" class="game-new"
                                                src="https://images.linkcdn.cloud/global/nav-addons/promo_category.png">
                                        </a>
                                    </div>
                                    <div class="game-item ">
                                    ...
                                    <div class="game-item">
                                        <a href="javascript:;">
                                            ...
                                            <img title="Advantplay" alt="Advantplay" class="game-maintenance"
                                    ...
                                    <div class="game-item ">
                                        <a href="javascript:;" onclick="gameAlert()">
                                            <img title="Playtech Casino" alt="Playtech Casino"
                                                src="https://images.linkcdn.cloud/global/game-skin1/navbar/casino/pca.webp">
    ...
    <div class="header-mobile">
        ...
        <!-- Banner -->
        @include('website.warmindo88.Auth.banner')
        <!-- /Banner -->
                                                ...
                                                <div class="slide-border">
                                                    <div class="slide-item">
                                                        <a onclick="routeNav('/slot/ais')" href="javascript:;">
                                                            ...
                                                            <div class="slide-title">AIS GAMING</div>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="slide-border">
                                                    <div class="slide-item">
                                                        <a href="javascript:;" onclick="gameAlert()">
                                                            <div class="slide-img">
                                                                <img title="N2Live Slot" alt="N2Live Slot"
                                                                    src="https://images.linkcdn.cloud/global/game-skin1/banner/slot/nli.webp">
                                                            </div>
                                                            <div class="slide-title">N2Live Slot</div>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="slide-border">
                                                            <div class="slide-item">
                                                                <a href="javascript:;" onclick="gameAlert()">
                                                                    <div class="slide-img">
                                                                        <img title="Playtech Casino"
                                                                            alt="Playtech Casino"
                                                                            src="https://images.linkcdn.cloud/global/game-skin1/banner/casino/pca.webp">
                                                                    </div>
                                                        ...
                                                        <div class="slide-border">
                                                            <div class="slide-item">
                                                                <a href="javascript:;" onclick="gameAlert()">
                                                                    <div class="slide-img">
                                                                        <img title="Spaceman" alt="Spaceman"
                                                                            src="https://images.linkcdn.cloud/global/game-skin1/banner/other/spa.webp">
                                                                    </div>
                                                                    <div class="slide-title">Spaceman</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">1892</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">6940</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">6371</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Senin, 2024-01-22</h6>
                                            <div class="lotto-number">3045</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Senin, 2024-01-22</h6>
                                            <div class="lotto-number">1383</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">6279</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">5373</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">5295</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">6362</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">7319</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Senin, 2024-01-22</h6>
                                            <div class="lotto-number">9824</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Senin, 2024-01-22</h6>
                                            <div class="lotto-number">3872</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">9516</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">4635</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">2064</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Minggu, 2024-01-21</h6>
                                            <div class="lotto-number">5000</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Senin, 2024-01-22</h6>
                                            <div class="lotto-number">2706</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="lotto-border">
                                    <a href="javascript:;" onclick="routeNav('/lottery/4d')">
                                        <div class="lotto-item">
                                            ...
                                            <h6 class="lotto-date">Selasa, 2024-01-23</h6>
                                            <div class="lotto-number">0656</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <footer class="footer">
        ...
        <div class="footer__trademark">Copyright &copy; 2021 - 2024
    ...
    <div class="footer-mobile">
        ...
        <a class="footer-item footer-login" href="#" data-toggle="modal" data-target="#loginModal">
            <div class="footer-icon">
                <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/loginbtn.svg"
                    width="60">
            </div>
        ...
        <a class="footer-item" target="_blank" rel="noreferrer"
            href="{{ asset('/') }}template_mahacuan/direct.lc.chat/15301668/">
            <div class="footer-icon">
    ...
    <script>
        ...
        $("a[name=locale-switch]").on("click", function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ asset('/') }}template_mahacuan/mahacuan.lol/locale",
                data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ asset('/') }}template_mahacuan/mahacuan.lol/paymentService",
                data: {
                    _token: "H70Ji0sMr3WqwcVdM9rtYysrRizX16tAQlO7v40x"
                },
        ...
        function routeNav(path) {
            ...
            $.ajax({
                ...
                success: function(page) {
                    ...
                    let checkPath = path.split('{{ route('apps.index') }}')
                }
            });
        }
    </script>
    ...
    <script>
        ...
        $("form[name=login-form]").on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ asset('/') }}template_mahacuan/mahacuan.lol/doLogin",
                type: 'POST',
                data: {
                    _token: "H70Ji0sMr3WqwcVdM9rtYysrRizX16tAQlO7v40x",
            ...
            var e = {
                ...
                init: function() {
                    ...
                    n.async = !0, n.type = "text/javascript", n.src =
                        "{{ asset('/') }}template_mahacuan/cdn.livechatinc.com/tracking.js", t.head
                        .appendChild(n)
                }
            };
    ...
    <noscript><a href="{{ asset('/') }}template_mahacuan/www.livechat.com/chat-with/15301668/"
            rel="nofollow">Chat with us</a>, powered by <a
            href="{{ asset('/') }}template_mahacuan/www.livechat.com/?welcome" rel="noopener nofollow"
...
<!-- Mirrored from mahacuan.lol/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jan 2024 15:30:21 GMT -->
