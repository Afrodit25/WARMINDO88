...
<head>
    ...
    <!-- Canonical -->
    <link rel="canonical" href="{{ route('mahacuan.tambah_dana') }}">
    <!-- End Canonical -->
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/') }}template_mahacuan/themes/1/sass/custom.css?v=2.0.1520">
    <style>
...
<body>
                ...
                <div class="marquee-cont">
                    ...
                    <div class="marquee-content">
                        <div class="marquee-date">
                            <div class="header-time" id="headerTime">Sun, December 31, 12:28:05 AM</div>
                        </div>
                    </div>
                ...
                <ul class="component-tabs nav nav-tabs" id="transactionTabs">
                    <li class="nav-item">
                        <a class="button-pills nav-link active" id="nav-deposit-tab" data-toggle="tab"
                            href="#nav-deposit" role="tab" aria-controls="nav-deposit"
                            aria-expanded="false">
    ...
    <script src="{{ asset('/') }}template_mahacuan/themes/1/js/global.js?v=2.0.1520"></script>
    ...
    <script type="text/javascript" src="{{ asset('/') }}template_mahacuan/themes/1/js/indeks.js?v=2.0.1520"></script>
