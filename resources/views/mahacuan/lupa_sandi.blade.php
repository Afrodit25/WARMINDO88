...
<!-- Mirrored from mahacuan.live/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Dec 2023 16:37:06 GMT -->
<!-- Added by HTTrack -->
        ...
        <div id="login-widget">
            <div class="widget-form">
                ...
                <div class="widget-form__logo">
                    <a href="index.html">
                        <img alt="WebsiteLogo" src="{{ asset('/') }}template_mahacuan/images.linkcdn.cloud/V2/779/logo/logo-1933674734.png">
                    </a>
                </div>
                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item">
                            <a href="javascript:;" class="nav-link" onclick="routeNav('/livegames')"
                                ...
                                <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/livegames.svg" width="80" alt="livegames">
                                <span class="nav-link-name">
                                    Live Game
                                </span>
                            </a>
                        ...
                        <div class="nav-item">
                            <a href="javascript:;" class="nav-link" onclick="routeNav('/casino')"
                                style="cursor: pointer;">
                                <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/casino.svg" width="80" alt="casino">
                                <span class="nav-link-name">
                                    Casino
                                </span>
                            </a>
                        ...
                        <div class="nav-item">
                            <a href="javascript:;" class="nav-link" onclick="routeNav('/sportsbook')"
                                style="cursor: pointer;">
                                <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/sport.svg" width="80" alt="sport">
                                <span class="nav-link-name">
                                    Sportsbook
                                </span>
                            </a>
    ...
    <div class="sidenav">
        ...
        <div class="sidenav__form">
            ...
            <div class="form-forgot">
                <a class="active" href="forgot-password.html">Lupa Password?</a>
            </div>
        </div>
        ...
        <div class="sidenav__menu">
            <div class="menu-list">
                <a href="index.html">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/home.svg" width="60" height="60">
                        <div class="menu-title">Home</div>
                    </div>
                </a>
                <a href="javascript:;" onclick="routeNav('/promotion')">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/promo.svg" width="60" height="60">
                        <div class="menu-title">Promosi</div>
                    </div>
                </a>
                <a href="download/MAHACUAN.apk">
                    <div class="list-item">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/download-apps.svg" width="60" height="60">
                        <div class="menu-title">Apps</div>
                    </div>
                </a>
                <a href="javascript:;" onclick="routeNav('/news')">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/news.svg" width="60" height="60">
                        <div class="menu-title">Berita</div>
                    </div>
                </a>
                <a href="help.html">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/help.svg" width="60" height="60">
                        <div class="menu-title">Bantuan</div>
                    </div>
                </a>
                <a href="contact.html">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/contactus.svg" width="60" height="60">
                        <div class="menu-title">Kontak Kami</div>
                    </div>
                </a>
                <a href="event.html">
                    <div class="list-item ">
                        <img src="{{ asset('/') }}template_mahacuan/themes/1/img/navigation/event.svg" width="60" height="60">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " value="" minlength="5" maxlength="100"
                                            id="username" style="text-transform: lowercase" name="username"
                                            type="text" placeholder="Nama Pengguna*" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="captcha-img">
                                            <img id="captchaForgot" src="{{ asset('/') }}template_mahacuan/captcha/default5ae2.png?2aJaaHqz">
                    ...
                    <div class="provider-content">
                        ...
                        <div class="provider-logo">
                            ...
                            <img alt="Pragmatic Play" title="Pragmatic Play"
                                src="{{ asset('/') }}template_mahacuan/images.linkcdn.cloud/global/logo-footer/casino/plc_footer.png" width="100"
                                height="50">
                            ...
                            <img alt="N2Live Slot" title="N2Live Slot"
                                src="{{ asset('/') }}template_mahacuan/images.linkcdn.cloud/global/logo-footer/casino/nli_footer.png" width="100"
                                height="50">
                            ...
                            <img alt="JDB" title="JDB"
                                src="{{ asset('/') }}template_mahacuan/images.linkcdn.cloud/global/logo-footer/casino/jdb_footer.png" width="100"
                                height="50">
