            ...
            <div class="widget-form__login collapse show" id="collapseheader">
                ...
                <div class="login-form-cont">
                    ...
                    <form id="login-form" method="POST" action="{{ route('apps.doLogin') }}">
                        @csrf
                        <input id="email" name="email" type="email" type="text"
                            placeholder="Email*" autocomplete="off" style="text-transform: lowercase"
                            required>
                            @if ($errors->has('email'))
                        ...
                        <input id="password" name="password" type="password"
                            ...
                            @endif
                        <button class="btn-custom" type="submit" id="btnLogin"
