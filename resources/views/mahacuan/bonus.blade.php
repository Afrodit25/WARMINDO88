...
<head>
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://mahacuan.wiki/bonus">
    <!-- End Canonical -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}template_mahacuan/themes/1/sass/custom.css?v=2.0.1520">
    <style>
                ...
                <div class="marquee-cont">
                    ...
                    <div class="marquee-content">
                        <div class="marquee-date">
                            <div class="header-time" id="headerTime">Mon, January 1, 4:26:54 AM</div>
                        </div>
                    </div>
        ...
        <div class="main-content bonus">
            <div class="container">
                <ul class="component-tabs nav nav-tabs" role="tablist" id="bonusTabs">
                    <li class="nav-item">
                        <a class="button-pills nav-item nav-link active" id="nav-promo-tab" href="#nav-promo"
                            data-toggle="tab" role="tab" aria-controls="nav-promo" aria-expanded="false">
                            <img src="https://mahacuan.live/themes/1/img/navigation/promotion.svg" width="40"
                                height="40">
                            <span>Promo</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="button-pills nav-item nav-link" id="nav-referral-tab" href="#nav-referral"
                            ...
                            <img src="https://mahacuan.live/themes/1/img/navigation/referal.svg" width="40"
                                height="40">
                            <span>Referral</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="button-pills nav-item nav-link" id="nav-turnover-tab" href="#nav-turnover"
                            ...
                            <img src="https://mahacuan.live/themes/1/img/navigation/rebate.svg" width="40"
                                height="40">
                ...
                <div class="component-tab-content tab-content">
                    <div class="tab-pane fade show active" id="nav-promo" role="tabpanel"
                            ...
                            <div class="container-fluid table-dataTable">
                                <div id="promoHistory_wrapper" class="dataTables_wrapper no-footer">
                                    ...
                                    <table class="table table-bordered dataTable no-footer dtr-" id="promoHistory"
                                        role="grid" aria-describedby="promoHistory_info"
                                        style="width: 1044px;">
                                        <thead>
                                            <tr role="row">
                                                <th scope="col" class="sorting_asc" rowspan="1"
                                                    colspan="1" style="width: 30px;" aria-label="No">No</th>
                                                <th scope="col" class="sorting" tabindex="0"
                                                    aria-controls="promoHistory" rowspan="1" colspan="1"
                                                    style="width: 155px;"
                                                    aria-label="Nama Permainan: activate to sort column ascending">
                                                    Nama Permainan</th>
                                                <th scope="col" class="sorting" tabindex="0"
                                                    aria-controls="promoHistory" rowspan="1" colspan="1"
                                                    style="width: 133px;"
                                                ...
                                                <th scope="col" class="sorting_disabled" rowspan="1"
                                                    ...
                                                    aria-label="Tanggal Mulai">Tanggal Mulai</th>
                                                <th scope="col" class="sorting" tabindex="0"
                                                    aria-controls="promoHistory" rowspan="1" colspan="1"
                                                    style="width: 137px;"
                                                    aria-label="Target Putaran: activate to sort column ascending">
                                                    Target Putaran</th>
                                                <th scope="col" class="sorting" tabindex="0"
                                                    aria-controls="promoHistory" rowspan="1" colspan="1"
                                                    style="width: 152px;"
                    ...
                    <div class="tab-pane fade" id="nav-referral" role="tabpanel"
                        aria-labelledby="nav-referral-tab">
                            ...
                            <div class="container-fluid table-dataTable">
                                <div id="downlineTable_wrapper" class="dataTables_wrapper no-footer">
                                    <div class="dataTables_length" id="downlineTable_length"><label>Show <select
                                                name="downlineTable_length" aria-controls="downlineTable"
                                                class="">
                                    ...
                                    <table class="table table-bordered dataTable no-footer dtr-" id="downlineTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th scope="col" class="sorting_asc" rowspan="1"
                                                    colspan="1" style="width: 0px;" aria-label=" No"> No</th>
                                                <th scope="col" class="sorting_disabled" rowspan="1"
                                                    colspan="1" style="width: 0px;" aria-label=" Pengguna">
                                                    Pengguna</th>
                                                <th scope="col" class="sorting_disabled" rowspan="1"
                                                    colspan="1" style="width: 0px;"
                                                    aria-label=" Tanggal register"> Tanggal register</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="odd">
                                    ...
                                    <div class="dataTables_paginate paging_simple_numbers"
                                        id="downlineTable_paginate"><a class="paginate_button previous disabled"
                                            aria-controls="downlineTable" data-dt-idx="0" tabindex="-1"
                    ...
                    <div class="tab-pane fade" id="nav-turnover" role="tabpanel"
                        aria-labelledby="nav-turnover-tab">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="dropdown bootstrap-select show-tick multi-select-game"
                                                style="width: 100%;"><select class="multi-select-game"
                                                    name="provider[]" multiple=""
                                                    data-selected-text-format="count > 4" tabindex="-98">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12">
                                        <div class="point-form">
                                            ...
                                            <div class="row point-form__holder">
                                                ...
                                                <div class="col-lg-7">
                                                    <div id="player-current_accumulation" class="point-form__item">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row point-form__holder">
    ...
    <custom-script>
        <script>
            ...
            if (location.hash == "#point") {
                $('#nav-point-tab').click()
                $('.tabs-sidebar').removeClass('active');
                $('#pointSidebar li').addClass('active');
            } else if (location.hash == "#referral") {
                $('#nav-referral-tab').click();
                $('.tabs-sidebar').removeClass('active');
                $('#referralSidebar li').addClass('active');
            } else if (location.hash == "#turnover") {
                $('#nav-turnover-tab').click();
                $('.tabs-sidebar').removeClass('active');
                $('#turnoverSidebar li').addClass('active');
            } else {
                (history.pushState) ? history.pushState(null, null, '#promo'): location.hash = '#promo';
                $('.tabs-sidebar').removeClass('active');
                $('#promoSidebar li').addClass('active');
            }
        </script>
        <script>
            $.ajax({
                type: "GET",
                url: "https://mahacuan.live/bonus/getPromoList",
                success: function(response) {
                    promoHistoryTable(response)
                },

            });

            function promoHistoryTable(dataSource) {
                $('#promoHistory').DataTable({
                    responsive: {
                        details: {
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#refferalRange').on('apply.daterangepicker', function(ev, picker) {
                    $('#from').val(picker.startDate.format('YYYY-MM-DD'));
                    $('#to').val(picker.endDate.format('YYYY-MM-DD'));
                })
                $('#downlineRange').val('');
                $('#downlineRange').on('apply.daterangepicker', function(ev, picker) {
                    $('#fromDown').val(picker.startDate.format('YYYY-MM-DD'));
                    $('#toDown').val(picker.endDate.format('YYYY-MM-DD'));
                })
                $.post("https://mahacuan.live/bonus/getDownline", {
                    _token: "yxHv1nVEH7HaN6cMoKXmi6KLAPk5CYabMFGrelti"
                }, (data) => {
                    $("#totalDownline").text(data.recordsTotal)
                    initDownlineTables($('#downlineTable'), data.data);
                });
            });
            ...
            $('#copyReff').click(function(e) {
                ...
                let $temp = $("<input>");
                $("body").append($temp);
                $temp.val("https://mahacuan.live/register/" + refText).select();
            ...
            function ViewReff(_this) {
                var url = "https://mahacuan.live/bonus/getData";
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    success: function(result) {
                        $('#referralTable').DataTable().clear().destroy()
                        initReffTables($('#referralTable'), result);
                        $(_this).text(LocalizationButtonMessage());
                    },
                    error: function(data) {
                        $(_this).text(LocalizationButtonMessage());
                        let msg = '';
            ...
            function ViewDownline(_this) {
                var url = "https://mahacuan.live/bonus/getDownline";
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    success: function(result) {
                        $('#downlineTable').DataTable().clear().destroy()
                        $("#totalDownline").text(result.recordsTotal)
                        initDownlineTables($('#downlineTable'), result.data);
                        $(_this).text("Cari");
                    },
                    error: function(data) {
                        $(_this).text("Cari");
            ...
            function LocalizationButtonMessage() {
                return "Lihat laporan Refferal";
            }

            function initReffTables(tableId, dataSource) {
                tableId.DataTable({
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.childRowImmediate,
                    ...
                    columns: [{
                        ...
                        data: 'status',
                        render: function(data) {
                            return (data != 1) ? '<div class="table-status pending">Pending</div>' :
                                '<div class="table-status approved">Release</div>'
                        }
                    }]
                });
            }

            function initDownlineTables(tableId, dataSource) {
                tableId.DataTable({
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.childRowImmediate,
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#turnoverRange').on('apply.daterangepicker', function(ev, picker) {
                    $('#from').val(picker.startDate.format('YYYY-MM-DD'));
                    $('#to').val(picker.endDate.format('YYYY-MM-DD'));
                })
            });
            ...
            function ViewTo(_this) {
                let values = $("select[name='provider[]']")
                    .map(function() {
                        return $(this).val();
                    }).get();
                let url = "https://mahacuan.live/bonus/turnover";
                let htmlExists = $(_this).html();
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    success: function(result) {
                        ...
                        $(_this).html(htmlExists);
                        if (data.length > 0) {
                            $('#turnoverTable').DataTable().clear().destroy()
                            initTablesTo($('#turnoverTable'), data);
                        } else {
                            return Swal.fire({
                                title: "Perhatian.",
                                html: "Data Turnover tidak ada",
                                timerProgressBar: true,
                                showButtonConfirm: false,
                                timer: 2000,
                            });
            ...
            function initTablesTo(tableId, dataSource) {
                tableId.DataTable({
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.childRowImmediate,
                    ...
                    footerCallback: function(data) {
                        ...
                        $.each(column, function(i, val) {
                            let calc = api.column(val).data().reduce(function(a, b) {
                                let result = a + parseFloat(b)
                                return parseFloat(result)
                            }, 0)
                            $(api.column(val).footer()).html((parseFloat(calc)).toFixed(2))
                        });
                    }
                });
            }
        ...
        <script>
            const replaceAmount = function(num) {
                return num.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')
            }

            function ViewRebate(_this) {
                let rebateRange = JSON.parse($("select[name='rebateRange']").val());
                let providers = $("select[name='rebateProvider[]']")
                    .map(function(data) {
                        return $(this).val()
                    }).get();
                let url = "https://mahacuan.live/bonus/rebate";
                ...
                $.ajax({
                    ...
                    data: {
                        _token: "yxHv1nVEH7HaN6cMoKXmi6KLAPk5CYabMFGrelti",
                        provideCode: providers,
                        tanggalRebate: $('#rebateDate').val(),
                        fromDate: rebateRange.startDate,
                        endDate: rebateRange.endDate
                    },
                    beforeSend: function() {
                        $(_this).html(
                            '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>'
                    ...
                    success: function(result) {
                        let data = result.data;
                        $('#rebateTable').DataTable().clear().destroy()
                        initTables($('#rebateTable'), data);
                        $(_this).text(LocalizationButtonMessage());
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        $(_this).text(LocalizationButtonMessage());
            ...
            function initTables(tableId, dataSource) {
                tableId.DataTable({
                    responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.childRowImmediate,
                    ...
                    columns: [{
                        ...
                        sortable: false,
                        render: function(data, type, row, meta) {
                            let startDate = new Date(row.start_date).toLocaleString('en-GB', {
                                year: 'numeric',
                                month: 'short',
                                day: 'numeric'
                            })
                            let endDate = new Date(row.end_date).toLocaleString('en-GB', {
                                year: 'numeric',
                                month: 'short',
                                day: 'numeric'
                            })
                        ...
                        render: function(data) {
                            let res = parseFloat(data)
                            return replaceAmount(res.toFixed(2))
                        }
                    }, {
                        data: 'rebate_value',
                        render: function(data) {
                    ...
                    footerCallback: function(data) {
                        ...
                        $.each(column, function(i, val) {
                            ...
                            $(api.column(val).footer()).html(replaceAmount((parseFloat(calc)).toFixed(2)))
                        });
                    }
                });
            }
        ...
        <script>
            function getEvent() {
                $.ajax({
                    type: "GET",
                    url: "https://mahacuan.live/bonus/getEvent",
                    success: function(res) {
                        $(`#event-banner_url`).attr("src", res.banner_url)
                        $(`#event-title`).text(res.title)
                        $(`#event-periode`).text(
                            `${new Date(res.start_date).toLocaleString('en-GB', { year: 'numeric', month: 'short', day: 'numeric'})} - ${new Date(res.end_date).toLocaleString('en-GB', { year: 'numeric', month: 'short', day: 'numeric'})}`
                            )
                        $(`#event-accumulation`).text(`${res.type} - ${~~res.accumulation} - 1 Point`)
            ...
            function getPlayerPoint() {
                $.ajax({
                    type: "GET",
                    url: "https://mahacuan.live/bonus/getPlayerPoint",
                    success: function(res) {
                        $(`#player-current_accumulation`).text(~~res.current_accumulation)
                        $(`#player-point`).text(`${res.point} Point`)
                    }
                });
            }
            ...
            function getReleasePoint() {
                $.ajax({
                    type: "GET",
                    url: "https://mahacuan.live/bonus/getReleasePoint",
                    success: function(res) {
                        if (res.success == false) {
                            $("#tbody-getReleasePoint").html(`
                    <tr>
                ...
                `)
                        ...
                        $.each(res, function(key, value) {
                            let release_date = value.released_date ? new Date(value.released_date)
                ...
                <tr>
                    <td class="text-center">
                        ${new Date(value.created_date).toLocaleString('en-GB', { year: 'numeric', month: 'short', day: 'numeric'})} <br> ${release_date}
                    </td>
                    <td class="text-center">${value.total_point}</td>
                    <td class="text-center">
                        <div class="table-status ${value.status.toLowerCase()}">${value.status}</div>
                    </td>
                    <td class="text-center">${value.remark}</td>
                </tr>
                `
                        });
                        $("#tbody-getReleasePoint").html(row)
                    }
                });
            }

            $('a[id="nav-point-tab"]').on('shown.bs.tab', function(e) {
                e.target
                e.relatedTarget
                getEvent()
                getPlayerPoint()
            ...
            function tukarPoint(_this) {
                var point = $("input[type='number']").val();
                var url = "https://mahacuan.live/bonus/doTukarPoint";
                $.ajax({
                    url: url,
                    type: 'POST',
                    data: {
